...
data_check<-data.frame(avg=double(),sd=double(),q1=double(),q2=double(),q3=double(),q4=double())
data_check[1,1]<-amazon4[,mean(diff_price,na.rm=TRUE)]
data_check[1,2]<-amazon4[,sd(diff_price,na.rm=TRUE)]
data_check[1,3]<-amazon4[,quantile(diff_price,c(0.25),na.rm=TRUE)]
data_check[1,4]<-amazon4[,quantile(diff_price,c(0.5),na.rm=TRUE)]
data_check[1,5]<-amazon4[,quantile(diff_price,c(0.75),na.rm=TRUE)]
data_check[1,6]<-amazon4[,quantile(diff_price,c(1),na.rm=TRUE)]
...
set.seed(31)
amazon4$id_rand<-runif(nrow(amazon4),min=0,max=1)
...
amazon5<amazon4[order(id_rand),decreasing=FALSE]
amazon6<-amazon5[1:100,]
data_check[2,1]<-amazon6[,mean(diff_price,na.rm=TRUE)]
data_check[2,2]<-amazon6[,sd(diff_price,na.rm=TRUE)]
data_check[2,3]<-amazon6[,quantile(diff_price,c(0.25),na.rm=TRUE)]
data_check[2,4]<-amazon6[,quantile(diff_price,c(0.5),na.rm=TRUE)]
data_check[2,5]<-amazon6[,quantile(diff_price,c(0.75),na.rm=TRUE)]
data_check[2,6]<-amazon6[,quantile(diff_price,c(1),na.rm=TRUE)]
data_check
## ==================================================================================================
...
amazon7<-amazon5[3771:3970,]
data_check[3,1]<-amazon7[,mean(diff_price,na.rm=TRUE)]
data_check[3,2]<-amazon7[,sd(diff_price,na.rm=TRUE)]
data_check[3,3]<-amazon7[,quantile(diff_price,c(0.25),na.rm=TRUE)]
data_check[3,4]<-amazon7[,quantile(diff_price,c(0.5),na.rm=TRUE)]
data_check[3,5]<-amazon7[,quantile(diff_price,c(0.75),na.rm=TRUE)]
data_check[3,6]<-amazon7[,quantile(diff_price,c(1),na.rm=TRUE)]
data_check
## ==================================================================================================
...
amazon8<-amazon5[1:1000,]
data_check[4,1]<-amazon8[,mean(diff_price,na.rm=TRUE)]
data_check[4,2]<-amazon8[,sd(diff_price,na.rm=TRUE)]
data_check[4,3]<-amazon8[,quantile(diff_price,c(0.25),na.rm=TRUE)]
data_check[4,4]<-amazon8[,quantile(diff_price,c(0.5),na.rm=TRUE)]
data_check[4,5]<-amazon8[,quantile(diff_price,c(0.75),na.rm=TRUE)]
data_check[4,6]<-amazon8[,quantile(diff_price,c(1),na.rm=TRUE)]
data_check
## ==================================================================================================
...
amazon9<-amazon5[2971:3970,]
data_check[5,1]<-amazon9[,mean(diff_price,na.rm=TRUE)]
data_check[5,2]<-amazon9[,sd(diff_price,na.rm=TRUE)]
data_check[5,3]<-amazon9[,quantile(diff_price,c(0.25),na.rm=TRUE)]
data_check[5,4]<-amazon9[,quantile(diff_price,c(0.5),na.rm=TRUE)]
data_check[5,5]<-amazon9[,quantile(diff_price,c(0.75),na.rm=TRUE)]
data_check[5,6]<-amazon9[,quantile(diff_price,c(1),na.rm=TRUE)]
data_check
## ==================================================================================================
...
## case?
##bigger sample is more accurate.
## ==================================================================================================
